...
const ForgotEmailNotFound: NextPage = () => {
        ...
        <Section innerWidth="container.md" >
            ...
            <Center height="100%" pt="20">
                <PageTransition
                    ...
                    <Heading variant={'h1'} size={'xl'} textAlign={'center'} py={7}>Reset password</Heading>
                    <Box display={'flex'} justifyContent={'center'} mb={20}>
                        <VStack maxW={400} py={10} spacing={5}>
                            <Image src="/static/images/action-failure.png" alt='Action Failure'/>
                            <Text fontSize="md" color="muted" textAlign={'center'} >
                                Reset link sent successfully, please check your eamil.
                            </Text>
                            <Button
                                variant='primary'
                                width={'full'}
...
export default ForgotEmailNotFound
