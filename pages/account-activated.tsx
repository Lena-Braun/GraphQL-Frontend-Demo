...
const AccountActivated: NextPage = () => {
        ...
        <Section innerWidth="container.md" >
            ...
            <Center height="100%" pt="20">
                <PageTransition
                    ...
                    <Heading variant={'h1'} size={'xl'} textAlign={'center'} py={7}>Account Activated</Heading>
                    <Box display={'flex'} justifyContent={'center'} mb={20}>
                        <VStack maxW={400} py={10} spacing={5}>
                            ...
                            <Text fontSize="md" color="muted" textAlign={'center'} >
                                Your account is verified successfully, please try login.
                            </Text>
                            <Button
                                variant='primary'
                                width={'full'}
